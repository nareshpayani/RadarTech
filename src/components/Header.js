                            ...
                            <Col lg="6" md="5">
                                <div className="bar-left">
                                    <ul className="list-unstyled list-inline">
                                        <li className="list-inline-item"><i className="las la-map-marker"></i>Marathalli, Banglore 560037.</li>
                                        <li className="list-inline-item"><Link to="#">Have Questions</Link></li>
                                    ...
                                    <div className="menu-box d-flex justify-content-between">
                                        <ul className="nav menu-nav">
                                            <li className="nav-item active">
                                                <Link className="nav-link dropdown-toggle" to={process.env.PUBLIC_URL + "/"} >Home </Link>
                                            ...
                                            <li className="nav-item dropdown">
                                                ...
                                                <ul className="dropdown list-unstyled">
                                                    ...
                                                    <li className="nav-item"><Link className="nav-link" to={process.env.PUBLIC_URL + "/course-list"}>C Programming</Link></li>
                                                    ...
                                                    <li className="nav-item"><Link className="nav-link" to={process.env.PUBLIC_URL + "/course-grid"}>Hardware</Link></li>
                                                </ul>
                                            </li>
